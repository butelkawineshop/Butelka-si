...
import type { Food, Media } from '@butelkawineshop/types'
...
export default async function FoodTemplate({ slug, locale, initialData, searchParams }: Props) {
  ...
  return (
    <ErrorBoundary>
      <Suspense fallback={<LoadingState />}>
        <div className="flex flex-col gap-8 sm:p-16" role="main" aria-label="Food Details">
          <DetailSlideshow
            title={item.title || ''}
          ...
          {/* Wines for this Food */}
          <div className="mt-12" role="complementary" aria-label="Wines for this Food">
